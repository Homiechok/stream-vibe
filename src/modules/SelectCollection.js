import BaseComponent from "@/utils/generic/BaseComponent.js";
...
class Select extends BaseComponent {
    ...
    bindEvents() {
        MatchMedia.mobile.addEventListener('change', this.onMobileMatchMedia)
